  ...
  <div class="cv-split__grid">
    ...
    <div class="cv-split__main">
      ...
      <section class="cv-split__section">
        ...
        <article class="cv-split__role cv-split__role--current">
          <h3 class="cv-split__role-title">
            Head of AI Solutions · <a href="https://alien.club">Alien Intelligence</a>
          </h3>
      ...
      <section class="cv-split__section">
        ...
        <article class="cv-split__role">
          <h3 class="cv-split__role-title">
            Project Director — Mobility &amp; Transportation · La Fabrique des Mobilités
          </h3>
        ...
        <article class="cv-split__role">
          <h3 class="cv-split__role-title">CEO &amp; Cofounder · Manwë</h3>
        ...
        <article class="cv-split__role">
          <h3 class="cv-split__role-title">
            Connector &amp; Project Manager · <a href="https://ouishare.net">Ouishare</a>
          </h3>
        ...
        <article class="cv-split__role">
          <h3 class="cv-split__role-title">Project Director — Consulting · Techneo</h3>
    ...
    <aside class="cv-split__sidebar" aria-label="Facts">
      ...
      <section class="cv-split__card">
        ...
        <ul class="cv-split__facts">
          <li>
            <strong>MBA, Business Administration</strong><br>
          ...
          <li>
            ...
            <a href="https://www.bristol.ac.uk">University of Bristol</a>, United Kingdom<br>
            <span class="cv-split__muted">2007 – 2008</span>
          </li>
          <li>
            <strong>Engineering Degree</strong> — Computer Science · Telecommunications · Signal Processing<br>
            <a href="https://www.imt-atlantique.fr">Télécom Bretagne</a> (now IMT Atlantique), Brest<br>
